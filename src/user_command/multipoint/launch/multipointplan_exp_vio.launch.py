...
def generate_launch_description():
    odom_topic = LaunchConfiguration('odom_topic', default='/vins/imu_propagate')
    next_distance = LaunchConfiguration('next_distance', default='0.7')
    fligt_type = LaunchConfiguration('fligt_type', default='4')
    ...
    return LaunchDescription([
        DeclareLaunchArgument('odom_topic', default_value='/vins/imu_propagate'),
        DeclareLaunchArgument('next_distance', default_value='0.7'),
        DeclareLaunchArgument('fligt_type', default_value='4'),
