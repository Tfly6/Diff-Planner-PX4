...
class DroneDetector
{
 public:
   ...
   */
  DroneDetector(rclcpp::Node::SharedPtr node);
 ...
 private:
  ...
  void rcvDepthColorCamPoseCallback(const sensor_msgs::msg::Image::ConstSharedPtr& depth_img,
                                const sensor_msgs::msg::Image::ConstSharedPtr& color_img,
                                const geometry_msgs::msg::PoseStamped::ConstSharedPtr& camera_pose);

  void rcvDepthCamPoseCallback(const sensor_msgs::msg::Image::ConstSharedPtr& depth_img,
                                const geometry_msgs::msg::PoseStamped::ConstSharedPtr& camera_pose);
  
  void rcvMyOdomCallback(const nav_msgs::msg::Odometry::ConstSharedPtr& odom);
  void rcvDepthImgCallback(const sensor_msgs::msg::Image::ConstSharedPtr& depth_img);

  void rcvDroneOdomCallbackBase(const nav_msgs::msg::Odometry::ConstSharedPtr& odom, const int drone_id);

  void rcvDrone0OdomCallback(const nav_msgs::msg::Odometry::ConstSharedPtr& odom);
  void rcvDrone1OdomCallback(const nav_msgs::msg::Odometry::ConstSharedPtr& odom);
  void rcvDrone2OdomCallback(const nav_msgs::msg::Odometry::ConstSharedPtr& odom);
  void rcvDroneXOdomCallback(const nav_msgs::msg::Odometry::ConstSharedPtr& odom);
  ...
  typedef message_filters::sync_policies::ApproximateTime<
    sensor_msgs::msg::Image, sensor_msgs::msg::Image, geometry_msgs::msg::PoseStamped> SyncPolicyDepthColorImagePose;
  typedef std::shared_ptr<message_filters::Synchronizer<SyncPolicyDepthColorImagePose>> SynchronizerDepthColorImagePose;
  typedef message_filters::sync_policies::ApproximateTime<
    sensor_msgs::msg::Image, geometry_msgs::msg::PoseStamped> SyncPolicyDepthImagePose;
